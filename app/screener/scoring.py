...
def rank_live_signal(
    *,
    ...
    accuracy_score = _clamp01(signal.metadata.get("accuracy_score"))
    false_positive_risk = _clamp01(signal.metadata.get("false_positive_risk_score"))
    ...
    components = {
        ...
        "accuracy_quality": max(0.0, accuracy_score * (1.0 - (false_positive_risk * 0.35))),
    ...
    weights = {
        ...
        "accuracy_quality": float(settings.screener_score_weight_accuracy_quality),
