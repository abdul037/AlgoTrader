...
- The live screener now applies configurable filters for price sanity, volume, dollar volume, spread, ATR, trend strength, choppiness, reward-to-risk, and regime alignment.
