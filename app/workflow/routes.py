...
@router.post("/run/ledger-cycle", response_model=WorkflowTaskResponse)
def run_ledger_cycle(request: Request) -> WorkflowTaskResponse:
    return _workflow(request).run_ledger_cycle()
